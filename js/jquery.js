...
(function(e, t) {
	...
	x.each({
		...
		return this.length
	}, x.fn.andSelf = x.fn.addBack, "object" == typeof module && module && "object" == typeof module.exports ? module.exports = x : (e.jQuery = e.$ = x, "function" == typeof define && define("jquery", [], function() {
		return x
	}))
})(window);
